...
# ===== SLIDE CREATION WITH FARMER IMAGES =====

# Slide 1: Title
add_title_slide("🌾 Kisan-Setu AI", "Smart Crop Insurance Portal")

# Slide 2: What is Kisan-Setu AI - with farmer image
farmer_url_1 = "https://images.unsplash.com/photo-1625246333195-78d9c38ad576?w=400&q=80"
...
# Slide 3: Features - with harvesting image
farmer_url_2 = "https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=400&q=80"
add_content_slide("Key Features", [
    "📸 Live Farm Photo Capture - Verify crop damage",
    "🛰️ Satellite Damage Analysis - AI-powered NDVI",
    "⚡ Instant Results - Approval within seconds",
    "💰 Direct Payout - Instant bank transfer",
    "📱 Mobile Friendly - Easy farmer access"
], farmer_url_2)

# Slide 4: How It Works
farmer_url_3 = "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=400&q=80"
add_content_slide("Claim Process", [
    "1️⃣ Enter Aadhaar/PAN number",
    "2️⃣ Upload clear photo of damaged crops",
    "3️⃣ AI verifies Bhulekh & geolocation",
    "4️⃣ Satellite NDVI analysis for damage %",
    "5️⃣ Instant approval/rejection with reasons"
], farmer_url_3)

# Slide 5: Benefits - with field image
farmer_url_4 = "https://images.unsplash.com/photo-1560493676-04071c5f467b?w=400&q=80"
add_content_slide("Benefits", [
    "💚 Reduces corruption - Fully automated",
    "⏱️ Saves time - No paperwork required",
    "🤝 Fair assessment - AI-powered decisions",
    "📊 Transparent - Detailed explanations",
...
# Slide 7: Supported Crops - with crops image
crops_url = "https://images.unsplash.com/photo-1488459716781-6a19ea2410ff?w=400&q=80"
...
success_url = "https://images.unsplash.com/photo-1552820728-8ac41f1ce891?w=400&q=80"
...
start_url = "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&q=80"
...
contact_url = "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&q=80"
...
print("✅ Enhanced Presentation created successfully with farmer images!")
print("📊 Total slides: 12")
print("🖼️ Farmer photos: Included with beautiful styling")
print("🎨 Professional design: Ready to impress!")
